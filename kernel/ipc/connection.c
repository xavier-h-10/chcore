...
void sys_ipc_return(u64 ret, u64 cap_num)
{
       ...
       // current_thread->thread_ctx->sc = conn->source->thread_ctx->sc; //TODO: check
        /* LAB 4 TODO END */
 ...
 * 1. Get the connection structure from the cap.
...
u64 sys_ipc_call(u32 conn_cap, struct ipc_msg *ipc_msg, u64 cap_num)
{
         ...
         * capabilities in server thread in the ipc_msg if cap_num > 0
         */
