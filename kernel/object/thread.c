...
#include "../include/lib/elf.h"
#include "../include/mm/kmalloc.h"
#include "../include/mm/mm.h"
#include "../include/mm/uaccess.h"
#include "../include/object/thread.h"
#include "../include/sched/context.h"
#include "../include/arch/aarch64/arch/machine/registers.h"
#include "../include/arch/aarch64/arch/machine/smp.h"
#include "../include/arch/aarch64/arch/time.h"
#include "../include/irq/ipi.h"
...
/* Arguments for the initial thread */
...
{
        kinfo("test_root_thread_basic called");
        BUG_ON(ptr == NULL);
...
void sys_thread_exit(void)
{
        ...
        thread_deinit(current_thread); // TODO: check obj_free?
        current_thread = NULL; // sched时current_thread=null直接返回,所以要设置一下
        /* LAB 3 TODO END */
        /* Reschedule */
        sched();
