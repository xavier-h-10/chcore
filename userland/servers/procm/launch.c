...
#include "../../../libchcore/include/chcore/assert.h"
#include "../../../libchcore/include/chcore/memory.h"
#include "../../../libchcore/include/chcore/thread.h"
#include "../../../libchcore/include/chcore/capability.h"
#include "../../../libchcore/include/chcore/internal/mem_layout.h"
#include "../../../libchcore/include/chcore/internal/raw_syscall.h"
#include "../../../libchcore/include/chcore/internal/utils.h"
...
int launch_process(struct launch_process_args *lp_args)
{
        ...
        // TODO: check PMO_ANONYM or PMO_DATA
        main_stack_cap =
        ...
        args.stack =
                MAIN_THREAD_STACK_BASE + MAIN_THREAD_STACK_SIZE - PAGE_SIZE;
        /* LAB 4 TODO END */
        args.pc = pc;
        args.arg = (u64)NULL;
        args.prio = MAX_PRIO;
